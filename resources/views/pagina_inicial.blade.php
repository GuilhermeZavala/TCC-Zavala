                        ...
                        <div class="col-lg-10 col-md-11 mx-auto">
                            <div class="detail-box">
                                <div>
                                    ...
                                    <h1> IDEAL PARA VOCÊ </h1>
                                    <p> Compare profissionais, conheça suas especialidades e encontre alguém preparado para
                                        ajudar você a alcançar seus objetivos. </p>
                                    <div class="">
                        ...
                        <div class="col-lg-10 col-md-11 mx-auto">
                            <div class="detail-box">
                                <div>
                                    <h3> ENCONTRE </h3>
                                    <h2> O LUGAR </h2>
                                    <h1> CERTO PARA SEU OBJETIVO </h1>
                                    <p> Procure academias, estúdios, boxes, centros esportivos e outros estabelecimentos de
                                        atividade física perto de você. </p>
                                    <div class="">
